#[doc = "Register `SCFG1` reader"]
pub type R = crate::R<Scfg1Spec>;
#[doc = "Register `SCFG1` writer"]
pub type W = crate::W<Scfg1Spec>;
...
impl W {
    #[doc = "Bit 0 - Stream enable / flag stream ready when read low"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, Scfg1Spec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Direct mode error interrupt enable"]
    #[inline(always)]
    pub fn dmeien(&mut self) -> DmeienW<'_, Scfg1Spec> {
        DmeienW::new(self, 1)
    }
    #[doc = "Bit 2 - Transfer error interrupt enable"]
    #[inline(always)]
    pub fn txeien(&mut self) -> TxeienW<'_, Scfg1Spec> {
        TxeienW::new(self, 2)
    }
    #[doc = "Bit 3 - Half transfer interrupt enable"]
    #[inline(always)]
    pub fn htxien(&mut self) -> HtxienW<'_, Scfg1Spec> {
        HtxienW::new(self, 3)
    }
    #[doc = "Bit 4 - Transfer complete interrupt enable"]
    #[inline(always)]
    pub fn txcien(&mut self) -> TxcienW<'_, Scfg1Spec> {
        TxcienW::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral flow controller"]
    #[inline(always)]
    pub fn perfc(&mut self) -> PerfcW<'_, Scfg1Spec> {
        PerfcW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Data transfer direction"]
    #[inline(always)]
    pub fn dircfg(&mut self) -> DircfgW<'_, Scfg1Spec> {
        DircfgW::new(self, 6)
    }
    #[doc = "Bit 8 - Circular mode"]
    #[inline(always)]
    pub fn circmen(&mut self) -> CircmenW<'_, Scfg1Spec> {
        CircmenW::new(self, 8)
    }
    #[doc = "Bit 9 - Peripheral increment mode"]
    #[inline(always)]
    pub fn perim(&mut self) -> PerimW<'_, Scfg1Spec> {
        PerimW::new(self, 9)
    }
    #[doc = "Bit 10 - Memory increment mode"]
    #[inline(always)]
    pub fn memim(&mut self) -> MemimW<'_, Scfg1Spec> {
        MemimW::new(self, 10)
    }
    #[doc = "Bits 11:12 - Peripheral data size"]
    #[inline(always)]
    pub fn persizecfg(&mut self) -> PersizecfgW<'_, Scfg1Spec> {
        PersizecfgW::new(self, 11)
    }
    #[doc = "Bits 13:14 - Memory data size"]
    #[inline(always)]
    pub fn memsizecfg(&mut self) -> MemsizecfgW<'_, Scfg1Spec> {
        MemsizecfgW::new(self, 13)
    }
    #[doc = "Bit 15 - Peripheral increment offset size"]
    #[inline(always)]
    pub fn periosize(&mut self) -> PeriosizeW<'_, Scfg1Spec> {
        PeriosizeW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Priority level"]
    #[inline(always)]
    pub fn prilcfg(&mut self) -> PrilcfgW<'_, Scfg1Spec> {
        PrilcfgW::new(self, 16)
    }
    #[doc = "Bit 18 - Double buffer mode"]
    #[inline(always)]
    pub fn dbm(&mut self) -> DbmW<'_, Scfg1Spec> {
        DbmW::new(self, 18)
    }
    #[doc = "Bit 19 - Current target (only in double buffer mode)"]
    #[inline(always)]
    pub fn ctarg(&mut self) -> CtargW<'_, Scfg1Spec> {
        CtargW::new(self, 19)
    }
    #[doc = "Bit 20 - ACK"]
    #[inline(always)]
    pub fn ack(&mut self) -> AckW<'_, Scfg1Spec> {
        AckW::new(self, 20)
    }
    #[doc = "Bits 21:22 - Peripheral burst transfer configuration"]
    #[inline(always)]
    pub fn pbcfg(&mut self) -> PbcfgW<'_, Scfg1Spec> {
        PbcfgW::new(self, 21)
    }
    #[doc = "Bits 23:24 - Memory burst transfer configuration"]
    #[inline(always)]
    pub fn mbcfg(&mut self) -> MbcfgW<'_, Scfg1Spec> {
        MbcfgW::new(self, 23)
    }
    #[doc = "Bits 25:27 - Channel selection"]
    #[inline(always)]
    pub fn chsel(&mut self) -> ChselW<'_, Scfg1Spec> {
        ChselW::new(self, 25)
    }
}
#[doc = "stream x configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`scfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`scfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Scfg1Spec;
impl crate::RegisterSpec for Scfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`scfg1::R`](R) reader structure"]
impl crate::Readable for Scfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`scfg1::W`](W) writer structure"]
impl crate::Writable for Scfg1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SCFG1 to value 0"]
impl crate::Resettable for Scfg1Spec {}
