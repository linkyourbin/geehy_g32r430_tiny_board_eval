...
impl W {
    #[doc = "Bits 0:1 - FIFO threshold selection"]
    #[inline(always)]
    pub fn fthsel(&mut self) -> FthselW<'_, Fctrl0Spec> {
        FthselW::new(self, 0)
    }
    #[doc = "Bit 2 - Direct mode disable"]
    #[inline(always)]
    pub fn dmden(&mut self) -> DmdenW<'_, Fctrl0Spec> {
        DmdenW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    pub fn feien(&mut self) -> FeienW<'_, Fctrl0Spec> {
        FeienW::new(self, 7)
    }
}
...
#[doc = "`reset()` method sets FCTRL0 to value 0x20"]
