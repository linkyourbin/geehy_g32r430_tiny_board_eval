#[doc = "Register `FCTRL1` reader"]
pub type R = crate::R<Fctrl1Spec>;
#[doc = "Register `FCTRL1` writer"]
pub type W = crate::W<Fctrl1Spec>;
...
impl W {
    #[doc = "Bits 0:1 - FIFO threshold selection"]
    #[inline(always)]
    pub fn fthsel(&mut self) -> FthselW<'_, Fctrl1Spec> {
        FthselW::new(self, 0)
    }
    #[doc = "Bit 2 - Direct mode disable"]
    #[inline(always)]
    pub fn dmden(&mut self) -> DmdenW<'_, Fctrl1Spec> {
        DmdenW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    pub fn feien(&mut self) -> FeienW<'_, Fctrl1Spec> {
        FeienW::new(self, 7)
    }
}
#[doc = "stream x FIFO control register\n\nYou can [`read`](crate::Reg::read) this register and get [`fctrl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fctrl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fctrl1Spec;
impl crate::RegisterSpec for Fctrl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fctrl1::R`](R) reader structure"]
impl crate::Readable for Fctrl1Spec {}
#[doc = "`write(|w| ..)` method takes [`fctrl1::W`](W) writer structure"]
impl crate::Writable for Fctrl1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FCTRL1 to value 0x20"]
impl crate::Resettable for Fctrl1Spec {
