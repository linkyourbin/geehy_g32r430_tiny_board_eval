...
#[doc = "Field `FTEN18` reader - Falling trigger event configuration of line 18"]
pub type Ften18R = crate::BitReader;
#[doc = "Field `FTEN18` writer - Falling trigger event configuration of line 18"]
pub type Ften18W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FTEN21` reader - Falling trigger event configuration of line 21"]
pub type Ften21R = crate::BitReader;
#[doc = "Field `FTEN21` writer - Falling trigger event configuration of line 21"]
pub type Ften21W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FTEN22` reader - Falling trigger event configuration of line 22"]
pub type Ften22R = crate::BitReader;
#[doc = "Field `FTEN22` writer - Falling trigger event configuration of line 22"]
pub type Ften22W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn ften22(&self) -> Ften22R {
        Ften22R::new(((self.bits >> 22) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Falling trigger event configuration of line 0"]
    #[inline(always)]
    pub fn ften0(&mut self) -> Ften0W<'_, FtenSpec> {
        Ften0W::new(self, 0)
    }
    #[doc = "Bit 1 - Falling trigger event configuration of line 1"]
    #[inline(always)]
    pub fn ften1(&mut self) -> Ften1W<'_, FtenSpec> {
        Ften1W::new(self, 1)
    }
    #[doc = "Bit 2 - Falling trigger event configuration of line 2"]
    #[inline(always)]
    pub fn ften2(&mut self) -> Ften2W<'_, FtenSpec> {
        Ften2W::new(self, 2)
    }
    #[doc = "Bit 3 - Falling trigger event configuration of line 3"]
    #[inline(always)]
    pub fn ften3(&mut self) -> Ften3W<'_, FtenSpec> {
        Ften3W::new(self, 3)
    }
    #[doc = "Bit 4 - Falling trigger event configuration of line 4"]
    #[inline(always)]
    pub fn ften4(&mut self) -> Ften4W<'_, FtenSpec> {
        Ften4W::new(self, 4)
    }
    #[doc = "Bit 5 - Falling trigger event configuration of line 5"]
    #[inline(always)]
    pub fn ften5(&mut self) -> Ften5W<'_, FtenSpec> {
        Ften5W::new(self, 5)
    }
    #[doc = "Bit 6 - Falling trigger event configuration of line 6"]
    #[inline(always)]
    pub fn ften6(&mut self) -> Ften6W<'_, FtenSpec> {
        Ften6W::new(self, 6)
    }
    #[doc = "Bit 7 - Falling trigger event configuration of line 7"]
    #[inline(always)]
    pub fn ften7(&mut self) -> Ften7W<'_, FtenSpec> {
        Ften7W::new(self, 7)
    }
    #[doc = "Bit 8 - Falling trigger event configuration of line 8"]
    #[inline(always)]
    pub fn ften8(&mut self) -> Ften8W<'_, FtenSpec> {
        Ften8W::new(self, 8)
    }
    #[doc = "Bit 9 - Falling trigger event configuration of line 9"]
    #[inline(always)]
    pub fn ften9(&mut self) -> Ften9W<'_, FtenSpec> {
        Ften9W::new(self, 9)
    }
    #[doc = "Bit 10 - Falling trigger event configuration of line 10"]
    #[inline(always)]
    pub fn ften10(&mut self) -> Ften10W<'_, FtenSpec> {
        Ften10W::new(self, 10)
    }
    #[doc = "Bit 11 - Falling trigger event configuration of line 11"]
    #[inline(always)]
    pub fn ften11(&mut self) -> Ften11W<'_, FtenSpec> {
        Ften11W::new(self, 11)
    }
    #[doc = "Bit 12 - Falling trigger event configuration of line 12"]
    #[inline(always)]
    pub fn ften12(&mut self) -> Ften12W<'_, FtenSpec> {
        Ften12W::new(self, 12)
    }
    #[doc = "Bit 13 - Falling trigger event configuration of line 13"]
    #[inline(always)]
    pub fn ften13(&mut self) -> Ften13W<'_, FtenSpec> {
        Ften13W::new(self, 13)
    }
    #[doc = "Bit 14 - Falling trigger event configuration of line 14"]
    #[inline(always)]
    pub fn ften14(&mut self) -> Ften14W<'_, FtenSpec> {
        Ften14W::new(self, 14)
    }
    #[doc = "Bit 15 - Falling trigger event configuration of line 15"]
    #[inline(always)]
    pub fn ften15(&mut self) -> Ften15W<'_, FtenSpec> {
        Ften15W::new(self, 15)
    }
    #[doc = "Bit 16 - Falling trigger event configuration of line 16"]
    #[inline(always)]
    pub fn ften16(&mut self) -> Ften16W<'_, FtenSpec> {
        Ften16W::new(self, 16)
    }
    #[doc = "Bit 17 - Falling trigger event configuration of line 17"]
    #[inline(always)]
    pub fn ften17(&mut self) -> Ften17W<'_, FtenSpec> {
        Ften17W::new(self, 17)
    }
    #[doc = "Bit 18 - Falling trigger event configuration of line 18"]
    #[inline(always)]
    pub fn ften18(&mut self) -> Ften18W<'_, FtenSpec> {
        Ften18W::new(self, 18)
    }
    #[doc = "Bit 21 - Falling trigger event configuration of line 21"]
    #[inline(always)]
    pub fn ften21(&mut self) -> Ften21W<'_, FtenSpec> {
        Ften21W::new(self, 21)
    }
    #[doc = "Bit 22 - Falling trigger event configuration of line 22"]
    #[inline(always)]
    pub fn ften22(&mut self) -> Ften22W<'_, FtenSpec> {
        Ften22W::new(self, 22)
    }
}
