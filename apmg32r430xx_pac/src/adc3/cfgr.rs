...
#[doc = "Field `ALIGN` reader - ADC data alignment"]
pub type AlignR = crate::BitReader;
#[doc = "Field `ALIGN` writer - ADC data alignment"]
...
pub type Awd1chW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ...
    #[doc = "Bit 10 - ADC group regular external trigger polarity"]
    #[inline(always)]
    ...
    #[doc = "Bits 26:29 - ADC analog watchdog 1 monitored channel selection"]
    #[inline(always)]
    pub fn awd1ch(&self) -> Awd1chR {
        Awd1chR::new(((self.bits >> 26) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - ADC DMA transfer enable"]
