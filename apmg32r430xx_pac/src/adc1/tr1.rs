...
pub type Lt1W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
...
pub type Ht1W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - ADC analog watchdog 1 threshold low"]
    #[inline(always)]
    pub fn lt1(&self) -> Lt1R {
        Lt1R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - ADC analog watchdog 1 threshold high"]
    #[inline(always)]
    pub fn ht1(&self) -> Ht1R {
        Ht1R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - ADC analog watchdog 1 threshold low"]
...
#[doc = "`reset()` method sets TR1 to value 0"]
