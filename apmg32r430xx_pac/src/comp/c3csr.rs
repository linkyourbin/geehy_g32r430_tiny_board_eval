#[doc = "Register `C3CSR` reader"]
pub type R = crate::R<C3csrSpec>;
#[doc = "Register `C3CSR` writer"]
pub type W = crate::W<C3csrSpec>;
...
#[doc = "Field `VN_SEL` reader - Comparator 3 negative terminal input voltage select"]
pub type VnSelR = crate::FieldReader;
#[doc = "Field `VN_SEL` writer - Comparator 3 negative terminal input voltage select"]
pub type VnSelW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `VP_SEL` reader - Comparator 3 positive input voltage select"]
pub type VpSelR = crate::FieldReader;
#[doc = "Field `VP_SEL` writer - Comparator 3 positive input voltage select"]
...
impl R {
    ...
    #[doc = "Bits 4:5 - Comparator 3 negative terminal input voltage select"]
    #[inline(always)]
    pub fn vn_sel(&self) -> VnSelR {
        VnSelR::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 6:7 - Comparator 3 positive input voltage select"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Module enablement"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, C3csrSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bits 1:3 - Comparator Digital Filter Timing Selection"]
    #[inline(always)]
    pub fn filter(&mut self) -> FilterW<'_, C3csrSpec> {
        FilterW::new(self, 1)
    }
    #[doc = "Bits 4:5 - Comparator 3 negative terminal input voltage select"]
    #[inline(always)]
    pub fn vn_sel(&mut self) -> VnSelW<'_, C3csrSpec> {
        VnSelW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Comparator 3 positive input voltage select"]
    #[inline(always)]
    pub fn vp_sel(&mut self) -> VpSelW<'_, C3csrSpec> {
        VpSelW::new(self, 6)
    }
    #[doc = "Bits 8:11 - TMR_SEL"]
    #[inline(always)]
    pub fn tmr_sel(&mut self) -> TmrSelW<'_, C3csrSpec> {
        TmrSelW::new(self, 8)
    }
    #[doc = "Bit 15 - The output polarity of comparator ."]
    #[inline(always)]
    pub fn pol(&mut self) -> PolW<'_, C3csrSpec> {
        PolW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Delay function enabled"]
    #[inline(always)]
    pub fn hys(&mut self) -> HysW<'_, C3csrSpec> {
        HysW::new(self, 16)
    }
    #[doc = "Bits 18:20 - Shielded signal for comparator channel selection."]
    #[inline(always)]
    pub fn blanksel(&mut self) -> BlankselW<'_, C3csrSpec> {
        BlankselW::new(self, 18)
    }
    #[doc = "Bit 31 - lock"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<'_, C3csrSpec> {
        LockW::new(self, 31)
    }
}
#[doc = "Comparator 3 control register.\n\nYou can [`read`](crate::Reg::read) this register and get [`c3csr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`c3csr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C3csrSpec;
impl crate::RegisterSpec for C3csrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c3csr::R`](R) reader structure"]
impl crate::Readable for C3csrSpec {}
#[doc = "`write(|w| ..)` method takes [`c3csr::W`](W) writer structure"]
impl crate::Writable for C3csrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets C3CSR to value 0"]
impl crate::Resettable for C3csrSpec {}
