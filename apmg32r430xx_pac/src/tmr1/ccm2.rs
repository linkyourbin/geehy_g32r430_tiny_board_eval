#[doc = "Register `CCM2` reader"]
pub type R = crate::R<Ccm2Spec>;
#[doc = "Register `CCM2` writer"]
pub type W = crate::W<Ccm2Spec>;
...
impl W {
    #[doc = "Bits 0:1 - Capture/Compare 3 selection"]
    #[inline(always)]
    pub fn cc3sel(&mut self) -> Cc3selW<'_, Ccm2Spec> {
        Cc3selW::new(self, 0)
    }
    #[doc = "Bit 2 - Output compare 3 fast enable"]
    #[inline(always)]
    pub fn oc3fen(&mut self) -> Oc3fenW<'_, Ccm2Spec> {
        Oc3fenW::new(self, 2)
    }
    #[doc = "Bit 3 - Output compare 3 preload enable"]
    #[inline(always)]
    pub fn oc3pen(&mut self) -> Oc3penW<'_, Ccm2Spec> {
        Oc3penW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Output compare 3 mode"]
    #[inline(always)]
    pub fn oc3mod(&mut self) -> Oc3modW<'_, Ccm2Spec> {
        Oc3modW::new(self, 4)
    }
    #[doc = "Bit 7 - Output compare 3 clear enable"]
    #[inline(always)]
    pub fn oc3cen(&mut self) -> Oc3cenW<'_, Ccm2Spec> {
        Oc3cenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Capture/Compare 4 selection"]
    #[inline(always)]
    pub fn cc4sel(&mut self) -> Cc4selW<'_, Ccm2Spec> {
        Cc4selW::new(self, 8)
    }
    #[doc = "Bit 10 - Output compare 4 fast enable"]
    #[inline(always)]
    pub fn oc4fen(&mut self) -> Oc4fenW<'_, Ccm2Spec> {
        Oc4fenW::new(self, 10)
    }
    #[doc = "Bit 11 - Output compare 4 preload enable"]
    #[inline(always)]
    pub fn oc4pen(&mut self) -> Oc4penW<'_, Ccm2Spec> {
        Oc4penW::new(self, 11)
    }
    #[doc = "Bits 12:14 - Output compare 4 mode"]
    #[inline(always)]
    pub fn oc4mod(&mut self) -> Oc4modW<'_, Ccm2Spec> {
        Oc4modW::new(self, 12)
    }
    #[doc = "Bit 15 - Output compare 4 clear enable"]
    #[inline(always)]
    pub fn oc4cen(&mut self) -> Oc4cenW<'_, Ccm2Spec> {
        Oc4cenW::new(self, 15)
    }
}
#[doc = "capture/compare mode register 2 (output mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`ccm2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccm2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ccm2Spec;
impl crate::RegisterSpec for Ccm2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ccm2::R`](R) reader structure"]
impl crate::Readable for Ccm2Spec {}
#[doc = "`write(|w| ..)` method takes [`ccm2::W`](W) writer structure"]
impl crate::Writable for Ccm2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CCM2 to value 0"]
impl crate::Resettable for Ccm2Spec {}
