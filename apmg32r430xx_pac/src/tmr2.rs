...
pub struct RegisterBlock {
    ...
    sts: Sts,
    ceg: Ceg,
    _reserved_6_ccm1: [u8; 0x04],
    _reserved_7_ccm2: [u8; 0x04],
    ccen: Ccen,
    cnt: Cnt,
    psc: Psc,
    autorld: Autorld,
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn ccm1_compare(&self) -> &Ccm1Compare {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(24).cast() }
    }
    ...
    #[inline(always)]
    pub const fn ccm2_compare(&self) -> &Ccm2Compare {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(28).cast() }
    }
...
pub mod ceg;
#[doc = "CCM1_COMPARE (rw) register accessor: capture/compare mode register 1 (output mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`ccm1_compare::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccm1_compare::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ccm1_compare`] module"]
#[doc(alias = "CCM1_COMPARE")]
pub type Ccm1Compare = crate::Reg<ccm1_compare::Ccm1CompareSpec>;
#[doc = "capture/compare mode register 1 (output mode)"]
pub mod ccm1_compare;
...
#[doc = "CCM2_COMPARE (rw) register accessor: capture/compare mode register 2 (output mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`ccm2_compare::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccm2_compare::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ccm2_compare`] module"]
#[doc(alias = "CCM2_COMPARE")]
pub type Ccm2Compare = crate::Reg<ccm2_compare::Ccm2CompareSpec>;
#[doc = "capture/compare mode register 2 (output mode)"]
pub mod ccm2_compare;
...
pub mod dmaddr;
#[doc = "OP (rw) register accessor: TMR4 option register\n\nYou can [`read`](crate::Reg::read) this register and get [`op::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`op::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@op`] module"]
#[doc(alias = "OP")]
pub type Op = crate::Reg<op::OpSpec>;
