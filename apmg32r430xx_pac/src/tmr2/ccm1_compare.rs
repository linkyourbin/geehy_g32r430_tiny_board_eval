#[doc = "Register `CCM1_COMPARE` reader"]
pub type R = crate::R<Ccm1CompareSpec>;
#[doc = "Register `CCM1_COMPARE` writer"]
pub type W = crate::W<Ccm1CompareSpec>;
...
impl W {
    #[doc = "Bits 0:1 - Capture/Compare 1 selection"]
    #[inline(always)]
    pub fn cc1sel(&mut self) -> Cc1selW<'_, Ccm1CompareSpec> {
        Cc1selW::new(self, 0)
    }
    #[doc = "Bit 2 - Output Compare 1 fast enable"]
    #[inline(always)]
    pub fn oc1fen(&mut self) -> Oc1fenW<'_, Ccm1CompareSpec> {
        Oc1fenW::new(self, 2)
    }
    #[doc = "Bit 3 - Output Compare 1 preload enable"]
    #[inline(always)]
    pub fn oc1pen(&mut self) -> Oc1penW<'_, Ccm1CompareSpec> {
        Oc1penW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Output Compare 1 mode"]
    #[inline(always)]
    pub fn oc1mod(&mut self) -> Oc1modW<'_, Ccm1CompareSpec> {
        Oc1modW::new(self, 4)
    }
    #[doc = "Bit 7 - Output Compare 1 clear enable"]
    #[inline(always)]
    pub fn oc1cen(&mut self) -> Oc1cenW<'_, Ccm1CompareSpec> {
        Oc1cenW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Capture/Compare 2 selection"]
    #[inline(always)]
    pub fn cc2sel(&mut self) -> Cc2selW<'_, Ccm1CompareSpec> {
        Cc2selW::new(self, 8)
    }
    #[doc = "Bit 10 - Output Compare 2 fast enable"]
    #[inline(always)]
    pub fn oc2fen(&mut self) -> Oc2fenW<'_, Ccm1CompareSpec> {
        Oc2fenW::new(self, 10)
    }
    #[doc = "Bit 11 - Output Compare 2 preload enable"]
    #[inline(always)]
    pub fn oc2pen(&mut self) -> Oc2penW<'_, Ccm1CompareSpec> {
        Oc2penW::new(self, 11)
    }
    #[doc = "Bits 12:14 - Output Compare 2 mode"]
    #[inline(always)]
    pub fn oc2mod(&mut self) -> Oc2modW<'_, Ccm1CompareSpec> {
        Oc2modW::new(self, 12)
    }
    #[doc = "Bit 15 - Output Compare 2 clear enable"]
    #[inline(always)]
    pub fn oc2cen(&mut self) -> Oc2cenW<'_, Ccm1CompareSpec> {
        Oc2cenW::new(self, 15)
    }
}
#[doc = "capture/compare mode register 1 (output mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`ccm1_compare::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccm1_compare::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ccm1CompareSpec;
impl crate::RegisterSpec for Ccm1CompareSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ccm1_compare::R`](R) reader structure"]
impl crate::Readable for Ccm1CompareSpec {}
#[doc = "`write(|w| ..)` method takes [`ccm1_compare::W`](W) writer structure"]
impl crate::Writable for Ccm1CompareSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CCM1_COMPARE to value 0"]
impl crate::Resettable for Ccm1CompareSpec {}
