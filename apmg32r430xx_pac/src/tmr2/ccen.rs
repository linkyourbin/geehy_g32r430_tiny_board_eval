...
#[doc = "Field `CC4NPOL` reader - Capture/Compare 4 output Polarity"]
pub type Cc4npolR = crate::BitReader;
#[doc = "Field `CC4NPOL` writer - Capture/Compare 4 output Polarity"]
pub type Cc4npolW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn cc4npol(&self) -> Cc4npolR {
        Cc4npolR::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Capture/Compare 1 output enable"]
    ...
    #[doc = "Bit 15 - Capture/Compare 4 output Polarity"]
    #[inline(always)]
    pub fn cc4npol(&mut self) -> Cc4npolW<'_, CcenSpec> {
        Cc4npolW::new(self, 15)
    }
}
